<template>
  <v-col cols="6" lg="3" md="4">
    <v-card class="rounded-xl mx-1 mb-2 cardListPokemon" color="secondary" elevation="5">
      <v-img class="img align-end text-white mt-3 mx-3" style="cursor: pointer" :src="props.url" height="90px"> </v-img>
